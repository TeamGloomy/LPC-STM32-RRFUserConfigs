...
M574 U2 S1 P"!xstopmax"                                                            ; configure active-low endstop for high end on X2 via pin e0stop


; Z-Probe
M950 S0 C"Servo0"                                                                  ; create Z3 for BLTouch
M558 P9 C"^Z3" H5 F120 T6000                                                       ; set Z probe type to bltouch and the dive height + speeds
...
M308 S1 P"PA0" Y"thermistor" T100000 B4725 C7.06e-8                                     ; configure sensor 1 as thermistor on pin duex.e2temp

M308 S2 P"e1temp" Y"thermistor" T100000 B4725 C7.06e-8                                  ; configure sensor 2 as thermistor on pin duex.e6temp

M308 S3 Y"mcu-temp" A"MCU" 								                                ; Configure sensor for MCU



M950 H0 C"hbed" T0                                                                      ; create bed heater output on bedheat and map it to sensor 0
...
M950 H1 C"he5" T1                                                                       ; create nozzle heater output on duex.e2heat and map it to sensor 1
M143 H1 S300                                                                            ; set temperature limit for heater 1 to 300C
M307 H1 R1.909 C166.0 D4.86 S1.00 V0.0                                                  ; disable bang-bang mode for heater  and set PWM limit

M950 H2 C"he4" T2                                                                       ; create nozzle heater output on duex.e6heat and map it to sensor 2
M143 H2 S300                                                                            ; set temperature limit for heater 2 to 300C
M307 H2 R1.841 C48.8 D6.13 S1.00 V0.0                                                   ; disable bang-bang mode for heater  and set PWM limit

; Fans
M950 F0 C"PA2" Q500                                                                     ; create fan 0 on pin duex.fan5 and set its frequency  -- HOTEND FAN left
M106 P0 S0 H1 T45                                                                       ; set fan 0 value. Thermostatic control is turned on -- HOTEND FAN left
M950 F1 C"PA1" Q500                                                                     ; create fan 1 on pin duex.fan6 and set its frequency -- HOTEND FAN  right
M106 P1 S0 H2 T45                                                                       ; set fan 1 value. Thermostatic control is turned on -- HOTEND FAN right

M950 F2 C"PE13" Q1000                                                                   ; create fan 2 on pin duex.fan3 and set its frequency -- TOOL FAN left
M106 P2 S0 H-1 C"Bauteil links"	                                         	            ; set fan 2 value. Thermostatic control is turned off -- TOOL FAN left
M950 F3 C"PF9" Q1000                                                                    ; create fan 3 on pin duex.fan4 and set its frequency -- TOOL FAN right
