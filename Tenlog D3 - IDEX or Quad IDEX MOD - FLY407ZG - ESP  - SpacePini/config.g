...
M569 P1 S1 D3 V10                                           ; physical drive 1 goes forwards
M569 P2 S1 D3 V10                                           ; physical drive 2 goes forwards
M569 P3 S1 D3 V10				            ; Physical drive 3 goes forwards (X2 on e0)
M569 P4 S1 D3 V10				            ; Physical drive 4 goes forwards (Z2 on e1)
...
M906 X1100 Y2000 Z1100 U1100 V1100 E1330:1330 I20                             ; set motor currents (mA) and motor idle factor in per cent
...
M574 Z1 S1 P"!zstop+!zstopmax"                                                ; Z axis with two motors, configure active-low endstops for low end on Z1+Z2 via pin zstop+zstopmax 
M574 U2 S1 P"!xstopmax"                                                       ; configure active-low endstop for high end on X2 via pin xstopmax


; Z-Probe
M950 S0 C"Servo0"                                                             ; create Servo0 for BLTouch
M558 P9 C"^Z3" H5 F120 T6000                                                  ; set Z probe type to BLTouch on pin Z3 and the dive height + speeds
...
M308 S3 Y"mcu-temp" A"MCU" 						      ; Configure sensor for MCU on pin mcu-temp
...
M950 F1 C"PA1" Q500                                                           ; create fan 1 on PA1 and set its frequency -- HOTEND FAN  right
...
M950 F3 C"PF9" Q1000                                                          ; create fan 3 on PF9 and set its frequency -- TOOL FAN right
...
; Automatic saving after power loss is disabled
